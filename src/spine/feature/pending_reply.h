...
/**
 * @file
 * @brief Pending Reply implementation declarations
 */

#ifndef SRC_SPINE_FEATURE_PENDING_REPLY_H_
#define SRC_SPINE_FEATURE_PENDING_REPLY_H_
...
#endif  // SRC_SPINE_FEATURE_PENDING_REPLY_H_
