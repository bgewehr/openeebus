...
/**
 * @file
 * @brief Pending Result Container implementation declarations
 */

#ifndef SRC_SPINE_FEATURE_PENDING_RESULT_CONTAINER_H_
#define SRC_SPINE_FEATURE_PENDING_RESULT_CONTAINER_H_
...
#endif  // SRC_SPINE_FEATURE_PENDING_RESULT_CONTAINER_H_
